...
-- Remember, every column you add takes up more audit table space and
-- slows audit inserts.
...
COMMENT ON COLUMN audit.logged_actions.hasura_user IS 'Hasura user whose statement caused the audited event';
COMMENT ON COLUMN audit.logged_actions.hasura_role IS 'Hasura role of user whose statement caused the audited event';
COMMENT ON COLUMN audit.logged_actions.hasura_user_id IS 'Hasura user-id of user whose statement caused the audited event';
...
COMMENT ON COLUMN audit.logged_actions.row_id IS 'Row _id of the row in the given table of the given schema on which operation was performed.';
